...
/************ process user parameters ************/
  ...
  //DrawMode
  if(     0==strcmpi(_DrawMode, "side"))   {DrawSide=true; DrawBottom=false; DrawFull=false;}
  else if(0==strcmpi(_DrawMode, "bottom")) {DrawSide=false; DrawBottom=true; DrawFull=false;}
  else if(0==strcmpi(_DrawMode, "both"))   {DrawSide=true; DrawBottom=true; DrawFull=true;}
  ...
  //HistoTypeSide
  if(     0==strcmpi(_HistoTypeSide, "Y"))   HistoTypeSide=hY;
  else if(0==strcmpi(_HistoTypeSide, "U"))   HistoTypeSide=hU;
  else if(0==strcmpi(_HistoTypeSide, "V"))   HistoTypeSide=hV;
  else if(0==strcmpi(_HistoTypeSide, "YUV")) HistoTypeSide=hYUV;
  else if(0==strcmpi(_HistoTypeSide, "UV"))  HistoTypeSide=hUV;
  else {user_error=true; goto throw_user_error;}

  //HistoTypeBottom
  if(     0==strcmpi(_HistoTypeBottom, "Y"))   HistoTypeBottom=hY;
  else if(0==strcmpi(_HistoTypeBottom, "U"))   HistoTypeBottom=hU;
  else if(0==strcmpi(_HistoTypeBottom, "V"))   HistoTypeBottom=hV;
  else if(0==strcmpi(_HistoTypeBottom, "YUV")) HistoTypeBottom=hYUV;
  else if(0==strcmpi(_HistoTypeBottom, "UV"))  HistoTypeBottom=hUV;
  else {user_error=true; goto throw_user_error;}

  //FrameType
  if(     0==strcmpi(_FrameType, "blank"))   FrameMode=fblank;
  else if(0==strcmpi(_FrameType, "colormap"))FrameMode=fcolormap;
  else if(0==strcmpi(_FrameType, "Y"))       FrameMode=fdistY;
  else if(0==strcmpi(_FrameType, "U"))       FrameMode=fdistU;
  else if(0==strcmpi(_FrameType, "V"))       FrameMode=fdistV;
  else if(0==strcmpi(_FrameType, "UV"))      FrameMode=fUV;
  else {user_error=true; goto throw_user_error;}
